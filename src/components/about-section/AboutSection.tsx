  ...
  return (
    ...
    <section id='about' className={Styles.about}>
      ...
      >          
          ...
          Creative and detail-oriented web designer with a strong passion for crafting visually appealing and user-friendly websites. Proficient in modern web design tools, including HTML, CSS,Typescript, JavaScript, and frameworks like Next.js. Adept at developing responsive layouts that enhance user experience across various devices and platforms. Experienced in UI/UX design principles, ensuring seamless navigation and intuitive interfaces. Capable of integrating front-end and back-end technologies for dynamic website functionality. Skilled in optimizing website performance, accessibility, and search engine visibility.
